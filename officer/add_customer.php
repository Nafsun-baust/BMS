...
if (isset($_POST['next'])) {
    ...
    $nid_find = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM customer
                                   WHERE nid = '$nid'"));

    if ($nid_find) {
        $error_nid = "This nid already registred";
        $error = true;
    }
    ...
    if (!$error) {
        ...
        mysqli_query($con, "INSERT INTO customer(nid,first_name,last_name,picture,email,phone,gender,address,city,state)
        VALUES('$nid','$first_name','$last_name','$filename','$email','$phone','$gender','$address','$city','$state')");
        ...
        <div class="main">
            ...
            <div class="crd">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-field">
                        <input type="number" name="nid" required spellcheck="false" value="<?php echo $nid ?>">
                        <label>NID</label>
                        <span><?php echo $error_nid ?></span>
                    </div>
                    ...
                    <div style="margin-top: -15px;" class="d-flex first">
                        <div class="input-field">
                            <input type="text" name="city" required spellcheck="false" value="<?php echo $city ?>">
                            <label>City</label>
                        </div>

                        <div class="input-field">
                            <input type="text" name="state" required spellcheck="false" value="<?php echo $state ?>">
                            <label>State</label>
                        </div>
