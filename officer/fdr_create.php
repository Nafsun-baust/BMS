...
<head>
    ...
    <title>Create FDR Account</title>
    <style>
        .main {
...
if (isset($_POST['create'])) {
    ...
    $query_fdr = "INSERT INTO `fdr`(`customer_id`, `scheme_id`,  `pin_code`, `status`, `opening_date`, `closing_date`,  `nom_name`, `nom_nid`, `nom_address`, `nom_relation`,principle_amount)
                VALUES ('$customer_id','$scheme','$pin_code','pending',CURDATE(),NULL,'$nom_name','$nom_nid','$nom_address','$nom_relation','$principle_amount')";
  
    mysqli_query($con, $query_fdr);
     
        
        header("Location: fdr_invoice.php");
                ...
                <form action="" method="post">
                    <div class="d-flex">
                        ...
                        <div class="dpsaccount">
                            ...
                            <div>
                                <h5 style="margin-left: 100px; margin-bottom:20px; margin-top:30px;">FDR Account Details</h5>
                                <div>
                                    <label class="">Scheme</label>
                                    <select class="sel"  name="scheme">
                                    <?php 
                                       $query_scheme = "SELECT * FROM fdr_scheme";
                                ...
                                <div>
                                    <label class="">FDR Amount</label>
                                    <input type="number" name="principle_amount" id="">
                                </div>
                                <div>
                            ...
                            <div class="btn_div">
                                <input type="submit" value="Create FDR Account" name="create" id="">
