...
$query = "SELECT MAX(dps_id) as id FROM dps";
        ...
        <div class="d-flex table_div">
            <div class="table1_div">
                <table class="table2">
                    ...
                    <header>DPS Account Details</header>
                    <tr>
                        <th>DPS Id</th>
                        <td><?php echo $row2['dps_id'] ?></td>
                    </tr>
                    <tr>
                        <th>Customer Id</th>
                ...
                <a href="dps_create.php"><button class="btnn">Ok</button></a>
            ...
            <div class="table2_div">
                <table class="table2">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row2['total_installment'] ?></td>
                    </tr>
                    <tr>
                        <th>Maturity Amount</th>
                        <td><?php echo $row2['maturity_amount'] . " Taka" ?></td>
                    </tr>
                    <tr>
                        <th>Installment Amount</th>
                        <td><?php echo $row2['installment_amount'] . " Taka" ?></td>
                    </tr>
                    <tr>
                        <th>Interest Rate</th>
