...
if (isset($_POST['update'])) {
    ...
    $query_fdr = "UPDATE `fdr` SET `pin_code`='$pin_code',`nom_name`='$nom_name',`nom_nid`='$nom_nid',`nom_address`='$nom_address',`nom_relation`='$nom_relation' WHERE fdr_id='$fdr_id'";

    mysqli_query($con, $query_fdr);
     
    $_SESSION['msg'] = "Updated fdr account successfully";
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dpsaccount">
                            ...
                            <div>
                                ...
                                <div>
                                    <label class="">FDR Id</label>
                                    <input type="text" name="scheme" value="<?php echo $row['fdr_id'] ?>" id="" disabled>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="scheme" value="<?php echo $row['principle_amount']." Taka" ?>" id="" disabled>
                                </div>
                                <div>
