...
if (isset($_POST['submit'])) {
    ...
    $query_scheme = "select * from fdr_scheme where tenure='$tenure'";
    ...
    if (!$error) {
        $query_insert = "INSERT INTO `fdr_scheme`( `tenure`, `interest_rate`)
        VALUES ('$tenure','$interest_rate')";
